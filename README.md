...
[![Logo](https://files.catbox.moe/c5s9g0.jpg)](https://web.crysnovax.link)
...
<p align="center">
   ...
   <br><br>
   <a href="https://web.crysnovax.link">
      <img src="https://img.shields.io/npm/v/@crysnovax/bailey?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://web.crysnovax.link">
      <img src="https://img.shields.io/npm/dm/@crysnovax/bailey?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://web.crysnovax.link">
      <img src="https://img.shields.io/badge/project-crysnovax%2Fbailey-6f42c1?style=for-the-badge&logo=github"/>
   </a>
   <a href="LICENSE">
...
🌐 Website: https://web.crysnovax.link
...
>
> To be clear, I’m **not** the original maintainer of Baileys all respect goes to the amazing work behind [@whiskeysockets/baileys](https://github.com/WhiskeySockets/Baileys). I only created and maintained my own fork ([@crysnovax/bailey](https://web.crysnovax.link)) where I spent a **lot** of time improving and adapting things on my own.
>
...
# NPM
"dependencies": {
   "@crysnovax/bailey": "latest"
}

# GitHub
"dependencies": {
   "@crysnovax/bailey": "@crysnovax/bailey"
}
```
...
```bash
# NPM
npm i @crysnovax/bailey@latest

# GitHub
npm i @crysnovax/bailey
```
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from '@crysnovax/bailey'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
sock.sendMessage(jid, {
   ...
   offerCode: '@crysnovax/bailey', // --- Optional
   offerUrl: 'https://web.crysnovax.link', // --- Optional
   ...
   nativeFlow: [{
      ...
      text: '📋 Copy',
      copy: '@crysnovax/bailey'
   }, {
      text: '🌐 Source',
      url: 'https://web.crysnovax.link'
   }, {
      text: '📋 Select',
      sections: [{
         title: '✨ Section 1',
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@crysnovax/bailey',
      offerUrl: 'https://web.crysnovax.link',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://web.crysnovax.link' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
// --- Create a new one
sock.newsletterCreate('@crysnovax/bailey')
...
// --- Change name
sock.newsletterUpdateName('120363402922206865@newsletter', '📦 @crysnovax/bailey')
...
sock.groupCreate('@crysnovax/bailey', ['628123456789@s.whatsapp.net'])
...
>
> This fork includes additional enhancements and modifications by [crysnovax](https://web.crysnovax.link)